// Code generated by protoc-gen-hello-gateway. DO NOT EDIT.
...
// The handlers forward requests to the hello endpoint over "conn".
...
// to "mux". The handlers forward requests to the hello endpoint over the given implementation of "HelloServiceClient".
